...
4. For `my_markets_threat`: If there is NO VERIFIABLE biosimilar activity in a country, you MUST set:
   - "risk_level": "None"
   - "company": null
   - "biosimilar": null
   - "phase": "None"
...
5. `verified_updates` and `social_noise` MUST contain real, verifiable entries (minimum 4–6 each). Do not leave them empty.
